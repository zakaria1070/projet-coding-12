...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="/work/store">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="date" class="form-control" id="" aria-describedby="emailHelp">
                              </div>
                              <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name='img_work' class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
